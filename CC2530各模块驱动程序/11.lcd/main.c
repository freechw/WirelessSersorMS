...
extern unsigned char gImage_peng[2960];
...
void main(void)
{
	...
	showhanzi16x16(0,0 + offset,0,tai,BLACK,BACK_COLOR);
	showhanzi16x16(17,0 + offset,0,wan,BLACK,BACK_COLOR);

	LCD_DrawLine(0, 34, 128, 34);

	LCD_DrawRectangle(10,90,80,110);


	Draw_Circle(100,60,10);//画圆
	...
	showimage(40,40,40,40,gImage_peng);
     while(1);
