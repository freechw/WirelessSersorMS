...
{
	if (sto_no >= 0 && (sto_no <=ENDPOIT_NUM - 1))
	{
		all_info_RT.env_no[sto_no].temperatureMAX = temMAX;
		all_info_RT.env_no[sto_no].temperatureMIN = temMIN;
		all_info_RT.env_no[sto_no].humidityMAX = humMAX;
		all_info_RT.env_no[sto_no].humidityMIN = humMIN;
		all_info_RT.env_no[sto_no].illuminationMAX = illMAX;
		all_info_RT.env_no[sto_no].illuminationMIN = illMIN;
	}
}
